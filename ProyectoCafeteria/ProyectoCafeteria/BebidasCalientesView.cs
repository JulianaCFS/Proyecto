...
{
	public partial class BebidasCalientesView : Gtk.Window
	{	
				...
				base(Gtk.WindowType.Toplevel)
		{
			...
			llenarTreeViewBebidasCalientes (treeView, dataReader);
			dataReader.Close ();
		}
		public  void llenarTreeViewBebidasCalientes(TreeView treeView, IDataReader dataReader) 
		{	
		...
		protected void OnTreeViewRowActivated (object o, RowActivatedArgs args)
		{
			...
			if (treeView.Selection.GetSelected (out model, out iterSelected)) {
				...
				SeleccionCantidad pantallaseleccion = new SeleccionCantidad (treeView, cantidad, 1, labelBebidasCalientes);
